          ...
          <div class="review-list-item">
            <div class="review-user">
              <?php if ($user->getGender() == 'male'): ?>
                <img src="https://geneonline.news/wp-content/uploads/2016/06/hedgehog2.png" class='icon-user'>
              <?php else: ?>
                <img src="https://www.bien.hu/userfiles/cikkek/113310/11160/original.jpg" class='icon-user'>
              <?php endif ?>
